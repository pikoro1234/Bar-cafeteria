...
<div class="container mb-lg-5 mb-4">
    <div class="card mb-lg-5 mb-4">
        <form class="mb-lg-5 mb-4 p-lg-5 p-4" method="POST" action="{{route ('edit-category',$datoCategria->id)}}">

            @csrf      

            <div class="input-group mb-3">                
                <input type="text" class="form-control" placeholder="Nombre categoria" id="nombreCategoria" name="nombreCategoriaEdit" aria-label="Nombre producto" aria-describedby="basic-addon1" value="{{$datoCategria->nombre}}">
            </div>
            <br>
